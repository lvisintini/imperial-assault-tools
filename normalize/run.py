...
class NormalizeImperialData(PipelineHelper):
    tasks = [
        ...
        # # TEMPLATES -> tasks.OpenCVAlignImages(cv2.MOTION_EUCLIDEAN, '../templates/side-mission-cards/homecoming.png', image_attr='image', source=SOURCES.AGENDA, root='./images', filter_function=lambda model: model['id'] in [56, ]),
        # # TEMPLATES -> tasks.OpenCVAlignImages(cv2.MOTION_EUCLIDEAN, '../templates/side-mission-cards/homecoming.png', image_attr='image', source=SOURCES.SIDE_MISSION, root='./images', filter_function=lambda model: model['id'] in [7, 23, 30, ]),
        # # TEMPLATES -> tasks.OpenCVAlignImages(cv2.MOTION_EUCLIDEAN, '../templates/side-mission-cards/homecoming.png', image_attr='image', source=SOURCES.THREAT_MISSION, root='./images', filter_function=lambda model: model['id'] in [1  ]),
        # # TEMPLATES -> tasks.OpenCVAlignImages(cv2.MOTION_EUCLIDEAN, '../templates/side-mission-cards/homecoming.png', image_attr='image', source=SOURCES.STORY_MISSION, root='./images', filter_function=lambda model: model['id'] in [9, ]),
        # # TEMPLATES -> tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'command-cards/of-no-importance.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['id'] in [104, 155, 0, 26, 32, 13]),

        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'agenda-cards/defensive-tactics-counter-strike.png', image_attr='image', source=SOURCES.AGENDA, filter_function=lambda model: not model['mission'], root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, '../templates/side-mission-cards/homecoming.png', image_attr='image', source=SOURCES.AGENDA, filter_function=lambda model: model['mission'] and model['period_restricted'], root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, '../templates/agenda-cards/stormtrooper-support-strength-of-command.png', image_attr='image', source=SOURCES.AGENDA, filter_function=lambda model: model['mission'] and not model['period_restricted'] and model['id'] != 60, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_HOMOGRAPHY, '../templates/agenda-cards/stormtrooper-support-strength-of-command.png', image_attr='image', source=SOURCES.AGENDA, filter_function=lambda model: model['id'] == 60, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, '../templates/side-mission-cards/born-from-death.png', image_attr='image', source=SOURCES.SIDE_MISSION, filter_function=lambda model: model['period_restricted'], root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, '../templates/side-mission-cards/cloud-citys-secret.png', image_attr='image', source=SOURCES.SIDE_MISSION, filter_function=lambda model: not model['period_restricted'] and model['id'] not in [26, 14], root='./images'),
        # tasks.OpenCVAlignImagesUsingCannyEdge(cv2.MOTION_AFFINE, '../templates/side-mission-cards/cloud-citys-secret.png', image_attr='image', source=SOURCES.SIDE_MISSION, filter_function=lambda model: model['id'] == 26, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_EUCLIDEAN, '../templates/side-mission-cards/cloud-citys-secret.png', image_attr='image', source=SOURCES.SIDE_MISSION, filter_function=lambda model: model['id'] == 14, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, '../templates/story-mission-cards/chain-of-command.png', image_attr='image', source=SOURCES.STORY_MISSION, root='./images', filter_function=lambda model: model['id'] not in [8, 19, 1, 2, 5, 26, 27, 7]),
        # tasks.OpenCVAlignImages(cv2.MOTION_EUCLIDEAN, '../templates/story-mission-cards/chain-of-command.png', image_attr='image', source=SOURCES.STORY_MISSION, root='./images', filter_function=lambda model: model['id'] in [8, 19, 1, 2, 5, 26, 27, 7]),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, '../templates/threat-mission-cards/scouring-of-the-homestead.png', image_attr='image', source=SOURCES.THREAT_MISSION, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_HOMOGRAPHY, '../templates/command-cards/mitigate.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['limit'] == 1 and model['cost'] == 0 and model['template'] == 'A'),
        # tasks.OpenCVAlignImages(cv2.MOTION_HOMOGRAPHY, '../templates/command-cards/of-no-importance.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['limit'] == 1 and model['cost'] == 0 and model['template'] == 'B'),
        # tasks.OpenCVAlignImagesUsingCannyEdge(cv2.MOTION_HOMOGRAPHY, '../templates/command-cards/tough-luck.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['limit'] == 1 and model['cost'] == 1 and model['template'] == 'A'),
        # tasks.OpenCVAlignImagesUsingCannyEdge(cv2.MOTION_HOMOGRAPHY, '../templates/command-cards/of-no-importance.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['limit'] == 1 and model['cost'] == 1 and model['template'] == 'B'),
        # tasks.OpenCVAlignImages(cv2.MOTION_HOMOGRAPHY, '../templates/command-cards/a-powerful-influence.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['limit'] == 1 and model['cost'] == 2 and model['template'] == 'A' and model['id'] == 52),
        # tasks.OpenCVAlignImagesUsingCannyEdge(cv2.MOTION_HOMOGRAPHY, '../templates/command-cards/a-powerful-influence.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['limit'] == 1 and model['cost'] == 2 and model['template'] == 'A' and model['id'] != 52),
        # tasks.OpenCVAlignImagesUsingCannyEdge(cv2.MOTION_AFFINE, '../templates/command-cards/comm-disruption.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['limit'] == 1 and model['cost'] == 2 and model['template'] == 'B'),
        # tasks.OpenCVAlignImagesUsingCannyEdge(cv2.MOTION_HOMOGRAPHY, '../templates/command-cards/crush.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['limit'] == 1 and model['cost'] == 3 and model['template'] == 'A'),
        # tasks.OpenCVAlignImagesUsingCannyEdge(cv2.MOTION_HOMOGRAPHY, '../templates/command-cards/crush.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['limit'] == 1 and model['cost'] == 3 and model['template'] == 'B'),
        # tasks.OpenCVAlignImagesUsingCannyEdge(cv2.MOTION_AFFINE, '../templates/command-cards/bodyguard.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['limit'] == 2 and model['id'] != 25),
        # tasks.OpenCVAlignImages(cv2.MOTION_HOMOGRAPHY, '../templates/command-cards/bodyguard.png', image_attr='image', source=SOURCES.COMMAND, root='./images', filter_function=lambda model: model['limit'] == 2 and model['id'] == 25),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'companion-cards/salacious-b-crumb.png', image_attr='image', source=SOURCES.COMPANION, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'condition-cards/weakened.png', image_attr='image', source=SOURCES.CONDITION, root='./images'),
        tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'deployment-cards/leia-organa-rebel-commander-campaign.png', image_attr='image', source=SOURCES.DEPLOYMENT, filter_function=lambda model: DEPLOYMENT_TRAITS.SKIRMISH_UPGRADE not in model['traits'], root='./images'),
        tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'deployment-cards/last-resort-skirmish.png', image_attr='image', source=SOURCES.DEPLOYMENT, filter_function=lambda model: DEPLOYMENT_TRAITS.SKIRMISH_UPGRADE in model['traits'], root='./images'),
        ...
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'supply-cards/troop-data.png', image_attr='image', source=SOURCES.SUPPLY, root='./images'),
        ...
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'imperial-class-cards/hutt-mercenaries-most-wanted.png', image_attr='image', source=SOURCES.REWARD, root='./images', filter_function=lambda model: model['empire'] and model['id'] != 31),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'imperial-class-cards/hutt-mercenaries-guild-hunters.png', image_attr='image', source=SOURCES.REWARD, root='./images', filter_function=lambda model: model['id'] == 31),

        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'upgrade-cards/electrostaff.png', image_attr='image', source=SOURCES.HERO_CLASS, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.MELEE, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'upgrade-cards/electrostaff.png', image_attr='image', source=SOURCES.UPGRADE, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.MELEE, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_HOMOGRAPHY, 'upgrade-cards/electrostaff.png', image_attr='image', source=SOURCES.REWARD, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.MELEE, root='./images'),

        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'upgrade-cards/dh-17.png', image_attr='image', source=SOURCES.HERO_CLASS, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.RANGED, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'upgrade-cards/dh-17.png', image_attr='image', source=SOURCES.UPGRADE, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.RANGED, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_HOMOGRAPHY, 'upgrade-cards/dh-17.png', image_attr='image', source=SOURCES.REWARD, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.RANGED, root='./images'),

        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'upgrade-cards/sniper-scope.png', image_attr='image', source=SOURCES.HERO_CLASS, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.RANGED_MOD, root='./images'),
        ...
        # tasks.OpenCVAlignImages(cv2.MOTION_HOMOGRAPHY, 'upgrade-cards/sniper-scope.png', image_attr='image', source=SOURCES.REWARD, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.RANGED_MOD, root='./images'),

        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'upgrade-cards/energized-hilt.png', image_attr='image', source=SOURCES.HERO_CLASS, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.MELEE_MOD, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'upgrade-cards/energized-hilt.png', image_attr='image', source=SOURCES.UPGRADE, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.MELEE_MOD, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_HOMOGRAPHY, 'upgrade-cards/energized-hilt.png', image_attr='image', source=SOURCES.REWARD, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.MELEE_MOD, root='./images'),

        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'upgrade-cards/laminate-armor.png', image_attr='image', source=SOURCES.HERO_CLASS, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.ARMOR, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'upgrade-cards/laminate-armor.png', image_attr='image', source=SOURCES.UPGRADE, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.ARMOR, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_HOMOGRAPHY, 'upgrade-cards/laminate-armor.png', image_attr='image', source=SOURCES.REWARD, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.ARMOR, root='./images'),

        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'upgrade-cards/concussion-grenades.png', image_attr='image', source=SOURCES.HERO_CLASS, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.EQUIPMENT, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'upgrade-cards/concussion-grenades.png', image_attr='image', source=SOURCES.UPGRADE, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.EQUIPMENT, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_HOMOGRAPHY, 'upgrade-cards/concussion-grenades.png', image_attr='image', source=SOURCES.REWARD, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.EQUIPMENT, root='./images'),

        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'hero-class-cards/davith-elso-embody-the-force.png', image_attr='image', source=SOURCES.HERO_CLASS, filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.FEAT, root='./images'),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'hero-class-cards/davith-elso-embody-the-force.png', image_attr='image', source=SOURCES.REWARD, root='./images', filter_function=lambda model: model['type'] == HERO_CLASS_UPGRADE_TYPES.FEAT and not model['empire']),


        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'card-backs/threat-mission-return-to-hoth.png', image_attr='image', source=SOURCES.CARD, root='./images', filter_function=lambda m: m['deck'] in ['Side Mission', 'Story Mission', 'Threat Mission']),
        # tasks.OpenCVAlignImages(cv2.MOTION_EUCLIDEAN, 'card-backs/deployment-imperial.png', image_attr='image', source=SOURCES.CARD, root='./images', filter_function=lambda m: m['deck'] in ['Deployment', ]),
        # tasks.OpenCVAlignImagesUsingCannyEdge(cv2.MOTION_EUCLIDEAN, 'card-backs/rebel-hero-gideon-argus.png', image_attr='image', source=SOURCES.CARD, root='./images', filter_function=lambda m: m['deck'] in ['Rebel Hero', ]),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'card-backs/imperial-class-inspiring-leadership.png', image_attr='image', source=SOURCES.CARD, root='./images', filter_function=lambda m: m['deck'] in ['Imperial Class', ]),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'card-backs/rebel-upgrade-tier-1.png', image_attr='image', source=SOURCES.CARD, root='./images', filter_function=lambda m: m['deck'] in ['Rebel Upgrade', ]),
        # tasks.OpenCVAlignImages(cv2.MOTION_AFFINE, 'card-backs/condition-focused.png', image_attr='image', source=SOURCES.CARD, root='./images', filter_function=lambda m: m['deck'] in ['Condition', ]),
